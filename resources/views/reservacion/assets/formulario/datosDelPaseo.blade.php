<div class="form-group" id="datosDelPaseo">
	<div class="alert alert-success col-sm-12 col-xs-12" id="ayudaFecha" role="alert">{!!Lang::get('formulario.SeleccionaUnaFecha')!!}</div>
	...
	<div class="form-group" id="tipoEmbarcacion">
		<div class="alert alert-success col-sm-12 col-xs-12" id="ayudaEmbarcacion" role="alert">{!!Lang::get('formulario.SeleccionDeEmbarcacionDisponible')!!}
		</div>
