...
Route::group(['prefix' => '/PanelAdministrativo'], function () {
    Route::get('/', ['uses' => 'PanelAdministrativoController@mostrarPanelAdministrativo', 'as' => 'PanelAdministrativo']);
    Route::get('/inicio', ['uses' => 'PanelAdministrativoController@mostrarFormularioEntrada', 'as' => 'loginPanel']);
